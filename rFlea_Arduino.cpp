...
void rFlea_Arduino::connect(){
  ant.opench(CH0);
}

void rFlea_Arduino::disconnect(){
  ant.closech(CH0);
}
...
void rFlea_Arduino::register_onMessage(void (*callback_funct)(byte * message)){
...
void rFlea_Arduino::send(byte* message){
